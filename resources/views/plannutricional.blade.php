...
@section('titulo', 'Plan Nutricional')
				...
				<div  class="card">
					<div class="card-content">
						...
						<div class="input-field col s14">
							<input type="text" name="day1" placeholder="Alimentos" class="input-field">
						</div>
						<div class="input-field col s14">
							<input type="text" name="day2" placeholder="Alimentos" class="input-field">
						</div>
						<div class="input-field col s14">
							<input type="text" name="day3" placeholder="Alimentos" class="input-field">
						</div>
						<div class="row">
       					</div>
					</div>
